...
import { parserMap } from './parser.js';
import { intsToLong } from './common.js';
export class Deserializer {
    ...
    mt_message() {
        ...
        if (!fn) {
            console.log('Not found predicate with id: 1538843921');
            return;
        }
        return fn.call(this);
    }
