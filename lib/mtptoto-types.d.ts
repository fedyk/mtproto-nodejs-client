...
export type Methods = InvokeAfterMsg | InvokeAfterMsgs | Auth$SendCode | Auth$SignUp | Auth$SignIn | Auth$LogOut | Auth$ResetAuthorizations | Auth$ExportAuthorization | Auth$ImportAuthorization | Auth$BindTempAuthKey | Account$RegisterDevice | Account$UnregisterDevice | Account$UpdateNotifySettings | Account$GetNotifySettings | Account$ResetNotifySettings | Account$UpdateProfile | Account$UpdateStatus | Account$GetWallPapers | Account$ReportPeer | Users$GetUsers | Users$GetFullUser | Contacts$GetContactIDs | Contacts$GetStatuses | Contacts$GetContacts | Contacts$ImportContacts | Contacts$DeleteContacts | Contacts$DeleteByPhones | Contacts$Block | Contacts$Unblock | Contacts$GetBlocked | Messages$GetMessages | Messages$GetDialogs | Messages$GetHistory | Messages$Search | Messages$ReadHistory | Messages$DeleteHistory | Messages$DeleteMessages | Messages$ReceivedMessages | Messages$SetTyping | Messages$SendMessage | Messages$SendMedia | Messages$ForwardMessages | Messages$ReportSpam | Messages$GetPeerSettings | Messages$Report | Messages$GetChats | Messages$GetFullChat | Messages$EditChatTitle | Messages$EditChatPhoto | Messages$AddChatUser | Messages$DeleteChatUser | Messages$CreateChat | Updates$GetState | Updates$GetDifference | Photos$UpdateProfilePhoto | Photos$UploadProfilePhoto | Photos$DeletePhotos | Upload$SaveFilePart | Upload$GetFile | Help$GetConfig | Help$GetNearestDc | Help$GetAppUpdate | Help$GetInviteText | Photos$GetUserPhotos | Messages$GetDhConfig | Messages$RequestEncryption | Messages$AcceptEncryption | Messages$DiscardEncryption | Messages$SetEncryptedTyping | Messages$ReadEncryptedHistory | Messages$SendEncrypted | Messages$SendEncryptedFile | Messages$SendEncryptedService | Messages$ReceivedQueue | Messages$ReportEncryptedSpam | Upload$SaveBigFilePart | InitConnection | Help$GetSupport | Messages$ReadMessageContents | Account$CheckUsername | Account$UpdateUsername | Contacts$Search | Account$GetPrivacy | Account$SetPrivacy | Account$DeleteAccount | Account$GetAccountTTL | Account$SetAccountTTL | InvokeWithLayer | Contacts$ResolveUsername | Account$SendChangePhoneCode | Account$ChangePhone | Messages$GetStickers | Messages$GetAllStickers | Account$UpdateDeviceLocked | Auth$ImportBotAuthorization | Messages$GetWebPagePreview | Account$GetAuthorizations | Account$ResetAuthorization | Account$GetPassword | Account$GetPasswordSettings | Account$UpdatePasswordSettings | Auth$CheckPassword | Auth$RequestPasswordRecovery | Auth$RecoverPassword | InvokeWithoutUpdates | Messages$ExportChatInvite | Messages$CheckChatInvite | Messages$ImportChatInvite | Messages$GetStickerSet | Messages$InstallStickerSet | Messages$UninstallStickerSet | Messages$StartBot | Help$GetAppChangelog | Messages$GetMessagesViews | Channels$ReadHistory | Channels$DeleteMessages | Channels$ReportSpam | Channels$GetMessages | Channels$GetParticipants | Channels$GetParticipant | Channels$GetChannels | Channels$GetFullChannel | Channels$CreateChannel | Channels$EditAdmin | Channels$EditTitle | Channels$EditPhoto | Channels$CheckUsername | Channels$UpdateUsername | Channels$JoinChannel | Channels$LeaveChannel | Channels$InviteToChannel | Channels$DeleteChannel | Updates$GetChannelDifference | Messages$EditChatAdmin | Messages$MigrateChat | Messages$SearchGlobal | Messages$ReorderStickerSets | Messages$GetDocumentByHash | Messages$GetSavedGifs | Messages$SaveGif | Messages$GetInlineBotResults | Messages$SetInlineBotResults | Messages$SendInlineBotResult | Channels$ExportMessageLink | Channels$ToggleSignatures | Auth$ResendCode | Auth$CancelCode | Messages$GetMessageEditData | Messages$EditMessage | Messages$EditInlineBotMessage | Messages$GetBotCallbackAnswer | Messages$SetBotCallbackAnswer | Contacts$GetTopPeers | Contacts$ResetTopPeerRating | Messages$GetPeerDialogs | Messages$SaveDraft | Messages$GetAllDrafts | Messages$GetFeaturedStickers | Messages$ReadFeaturedStickers | Messages$GetRecentStickers | Messages$SaveRecentSticker | Messages$ClearRecentStickers | Messages$GetArchivedStickers | Account$SendConfirmPhoneCode | Account$ConfirmPhone | Channels$GetAdminedPublicChannels | Messages$GetMaskStickers | Messages$GetAttachedStickers | Auth$DropTempAuthKeys | Messages$SetGameScore | Messages$SetInlineGameScore | Messages$GetGameHighScores | Messages$GetInlineGameHighScores | Messages$GetCommonChats | Help$SetBotUpdatesStatus | Messages$GetWebPage | Messages$ToggleDialogPin | Messages$ReorderPinnedDialogs | Messages$GetPinnedDialogs | Bots$SendCustomRequest | Bots$AnswerWebhookJSONQuery | Upload$GetWebFile | Payments$GetPaymentForm | Payments$GetPaymentReceipt | Payments$ValidateRequestedInfo | Payments$SendPaymentForm | Account$GetTmpPassword | Payments$GetSavedInfo | Payments$ClearSavedInfo | Messages$SetBotShippingResults | Messages$SetBotPrecheckoutResults | Stickers$CreateStickerSet | Stickers$RemoveStickerFromSet | Stickers$ChangeStickerPosition | Stickers$AddStickerToSet | Messages$UploadMedia | Phone$GetCallConfig | Phone$RequestCall | Phone$AcceptCall | Phone$ConfirmCall | Phone$ReceivedCall | Phone$DiscardCall | Phone$SetCallRating | Phone$SaveCallDebug | Upload$GetCdnFile | Upload$ReuploadCdnFile | Help$GetCdnConfig | Langpack$GetLangPack | Langpack$GetStrings | Langpack$GetDifference | Langpack$GetLanguages | Channels$EditBanned | Channels$GetAdminLog | Upload$GetCdnFileHashes | Messages$SendScreenshotNotification | Channels$SetStickers | Messages$GetFavedStickers | Messages$FaveSticker | Channels$ReadMessageContents | Contacts$ResetSaved | Messages$GetUnreadMentions | Channels$DeleteHistory | Help$GetRecentMeUrls | Channels$TogglePreHistoryHidden | Messages$ReadMentions | Messages$GetRecentLocations | Messages$SendMultiMedia | Messages$UploadEncryptedFile | Account$GetWebAuthorizations | Account$ResetWebAuthorization | Account$ResetWebAuthorizations | Messages$SearchStickerSets | Upload$GetFileHashes | Help$GetTermsOfServiceUpdate | Help$AcceptTermsOfService | Account$GetAllSecureValues | Account$GetSecureValue | Account$SaveSecureValue | Account$DeleteSecureValue | Users$SetSecureValueErrors | Account$GetAuthorizationForm | Account$AcceptAuthorization | Account$SendVerifyPhoneCode | Account$VerifyPhone | Account$SendVerifyEmailCode | Account$VerifyEmail | Help$GetDeepLinkInfo | Contacts$GetSaved | Channels$GetLeftChannels | Account$InitTakeoutSession | Account$FinishTakeoutSession | Messages$GetSplitRanges | InvokeWithMessagesRange | InvokeWithTakeout | Messages$MarkDialogUnread | Messages$GetDialogUnreadMarks | Contacts$ToggleTopPeers | Messages$ClearAllDrafts | Help$GetAppConfig | Help$SaveAppLog | Help$GetPassportConfig | Langpack$GetLanguage | Messages$UpdatePinnedMessage | Account$ConfirmPasswordEmail | Account$ResendPasswordEmail | Account$CancelPasswordEmail | Help$GetSupportName | Help$GetUserInfo | Help$EditUserInfo | Account$GetContactSignUpNotification | Account$SetContactSignUpNotification | Account$GetNotifyExceptions | Messages$SendVote | Messages$GetPollResults | Messages$GetOnlines | Messages$EditChatAbout | Messages$EditChatDefaultBannedRights | Account$GetWallPaper | Account$UploadWallPaper | Account$SaveWallPaper | Account$InstallWallPaper | Account$ResetWallPapers | Account$GetAutoDownloadSettings | Account$SaveAutoDownloadSettings | Messages$GetEmojiKeywords | Messages$GetEmojiKeywordsDifference | Messages$GetEmojiKeywordsLanguages | Messages$GetEmojiURL | Folders$EditPeerFolders | Messages$GetSearchCounters | Channels$GetGroupsForDiscussion | Channels$SetDiscussionGroup | Messages$RequestUrlAuth | Messages$AcceptUrlAuth | Messages$HidePeerSettingsBar | Contacts$AddContact | Contacts$AcceptContact | Channels$EditCreator | Contacts$GetLocated | Channels$EditLocation | Channels$ToggleSlowMode | Messages$GetScheduledHistory | Messages$GetScheduledMessages | Messages$SendScheduledMessages | Messages$DeleteScheduledMessages | Account$UploadTheme | Account$CreateTheme | Account$UpdateTheme | Account$SaveTheme | Account$InstallTheme | Account$GetTheme | Account$GetThemes | Auth$ExportLoginToken | Auth$ImportLoginToken | Auth$AcceptLoginToken | Account$SetContentSettings | Account$GetContentSettings | Channels$GetInactiveChannels | Account$GetMultiWallPapers | Messages$GetPollVotes | Messages$ToggleStickerSets | Payments$GetBankCardData | Messages$GetDialogFilters | Messages$GetSuggestedDialogFilters | Messages$UpdateDialogFilter | Messages$UpdateDialogFiltersOrder | Stats$GetBroadcastStats | Stats$LoadAsyncGraph | Stickers$SetStickerSetThumb | Bots$SetBotCommands | Messages$GetOldFeaturedStickers | Help$GetPromoData | Help$HidePromoData | Phone$SendSignalingData | Stats$GetMegagroupStats | Account$GetGlobalPrivacySettings | Account$SetGlobalPrivacySettings | Help$DismissSuggestion | Help$GetCountriesList | Messages$GetReplies | Messages$GetDiscussionMessage | Messages$ReadDiscussion | Contacts$BlockFromReplies | Stats$GetMessagePublicForwards | Stats$GetMessageStats | Messages$UnpinAllMessages | Phone$CreateGroupCall | Phone$JoinGroupCall | Phone$LeaveGroupCall | Phone$InviteToGroupCall | Phone$DiscardGroupCall | Phone$ToggleGroupCallSettings | Phone$GetGroupCall | Phone$GetGroupParticipants | Phone$CheckGroupCall | Messages$DeleteChat | Messages$DeletePhoneCallHistory | Messages$CheckHistoryImport | Messages$InitHistoryImport | Messages$UploadImportedMedia | Messages$StartHistoryImport | Messages$GetExportedChatInvites | Messages$GetExportedChatInvite | Messages$EditExportedChatInvite | Messages$DeleteRevokedExportedChatInvites | Messages$DeleteExportedChatInvite | Messages$GetAdminsWithInvites | Messages$GetChatInviteImporters | Messages$SetHistoryTTL | Account$ReportProfilePhoto | Channels$ConvertToGigagroup | Messages$CheckHistoryImportPeer | Phone$ToggleGroupCallRecord | Phone$EditGroupCallParticipant | Phone$EditGroupCallTitle | Phone$GetGroupCallJoinAs | Phone$ExportGroupCallInvite | Phone$ToggleGroupCallStartSubscription | Phone$StartScheduledGroupCall | Phone$SaveDefaultGroupCallJoinAs | Phone$JoinGroupCallPresentation | Phone$LeaveGroupCallPresentation | Stickers$CheckShortName | Stickers$SuggestShortName | Bots$ResetBotCommands | Bots$GetBotCommands | Account$ResetPassword | Account$DeclinePasswordReset | Auth$CheckRecoveryPassword | Account$GetChatThemes | Messages$SetChatTheme | Channels$ViewSponsoredMessage | Channels$GetSponsoredMessages | Messages$GetMessageReadParticipants | Messages$GetSearchResultsCalendar | Messages$GetSearchResultsPositions | Messages$HideChatJoinRequest | Messages$HideAllChatJoinRequests | Messages$ToggleNoForwards | Messages$SaveDefaultSendAs | Channels$GetSendAs | Account$SetAuthorizationTTL | Account$ChangeAuthorizationSettings | Channels$DeleteParticipantHistory | Messages$SendReaction | Messages$GetMessagesReactions | Messages$GetMessageReactionsList | Messages$SetChatAvailableReactions | Messages$GetAvailableReactions | Messages$SetDefaultReaction | Messages$TranslateText | Messages$GetUnreadReactions | Messages$ReadReactions | Contacts$ResolvePhone | Phone$GetGroupCallStreamChannels | Phone$GetGroupCallStreamRtmpUrl | Messages$SearchSentMedia | Messages$GetAttachMenuBots | Messages$GetAttachMenuBot | Messages$ToggleBotInAttachMenu | Messages$RequestWebView | Messages$ProlongWebView | Messages$RequestSimpleWebView | Messages$SendWebViewResultMessage | Messages$SendWebViewData | Bots$SetBotMenuButton | Bots$GetBotMenuButton | Account$GetSavedRingtones | Account$SaveRingtone | Account$UploadRingtone | Bots$SetBotBroadcastDefaultAdminRights | Bots$SetBotGroupDefaultAdminRights | Phone$SaveCallLog | Channels$ToggleJoinToSend | Channels$ToggleJoinRequest | Payments$ExportInvoice | Messages$TranscribeAudio | Messages$RateTranscribedAudio | Payments$AssignAppStoreTransaction | Payments$AssignPlayMarketTransaction | Payments$CanPurchasePremium | Help$GetPremiumPromo | Messages$GetCustomEmojiDocuments | Messages$GetEmojiStickers | Messages$GetFeaturedEmojiStickers | Account$UpdateEmojiStatus | Account$GetDefaultEmojiStatuses | Account$GetRecentEmojiStatuses | Account$ClearRecentEmojiStatuses | Messages$ReportReaction | Messages$GetTopReactions | Messages$GetRecentReactions | Messages$ClearRecentReactions | Messages$GetExtendedMedia | Auth$ImportWebTokenAuthorization | Account$ReorderUsernames | Account$ToggleUsername | Channels$ReorderUsernames | Channels$ToggleUsername | Channels$DeactivateAllUsernames | Channels$ToggleForum | Channels$CreateForumTopic | Channels$GetForumTopics | Channels$GetForumTopicsByID | Channels$EditForumTopic | Channels$UpdatePinnedForumTopic | Channels$DeleteTopicHistory | Channels$ReorderPinnedForumTopics | Channels$ToggleAntiSpam | Channels$ReportAntiSpamFalsePositive | Messages$SetDefaultHistoryTTL | Messages$GetDefaultHistoryTTL | Contacts$ExportContactToken | Contacts$ImportContactToken | Photos$UploadContactProfilePhoto | Channels$ToggleParticipantsHidden | Messages$SendBotRequestedPeer | Account$GetDefaultProfilePhotoEmojis | Account$GetDefaultGroupPhotoEmojis | Auth$RequestFirebaseSms | Messages$GetEmojiGroups | Messages$GetEmojiStatusGroups | Messages$GetEmojiProfilePhotoGroups | Messages$SearchCustomEmoji | Messages$TogglePeerTranslations | Account$GetAutoSaveSettings | Account$SaveAutoSaveSettings | Account$DeleteAutoSaveExceptions | Stickers$ChangeSticker | Stickers$RenameStickerSet | Stickers$DeleteStickerSet | Messages$GetBotApp | Messages$RequestAppWebView | Bots$SetBotInfo | Bots$GetBotInfo | Auth$ResetLoginEmail | Chatlists$ExportChatlistInvite | Chatlists$DeleteExportedInvite | Chatlists$EditExportedInvite | Chatlists$GetExportedInvites | Chatlists$CheckChatlistInvite | Chatlists$JoinChatlistInvite | Chatlists$GetChatlistUpdates | Chatlists$JoinChatlistUpdates | Chatlists$HideChatlistUpdates | Chatlists$GetLeaveChatlistSuggestions | Chatlists$LeaveChatlist | Bots$ReorderUsernames | Bots$ToggleUsername | Messages$SetChatWallPaper;
