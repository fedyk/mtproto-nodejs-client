...
return result;
  ...
  [2211011308, function() {
const result: any = { _: 'mt_p_q_inner_data' };
result.pq = this.bytes();
result.p = this.bytes();
result.q = this.bytes();
result.nonce = this.int128();
...
return result;
  ...
  [1013613780, function() {
const result: any = { _: 'mt_p_q_inner_data_temp' };
result.pq = this.bytes();
result.p = this.bytes();
result.q = this.bytes();
result.nonce = this.int128();
...
return result;
  ...
  [2043348061, function() {
const result: any = { _: 'mt_server_DH_params_fail' };
result.nonce = this.int128();
result.server_nonce = this.int128();
...
return result;
  ...
  [2249243371, function() {
const result: any = { _: 'mt_msg_resend_ans_req' };
result.msg_ids = this.vector(this.long, false);
return result;
  }],
  [3664378706, function() {
