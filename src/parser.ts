...
return result;
  ...
  [2851430293, function() {
const result: any = { _: 'mt_p_q_inner_data_dc' };
result.pq = this.bytes();
result.p = this.bytes();
result.q = this.bytes();
result.nonce = this.int128();
...
return result;
  ...
  [1459478408, function() {
const result: any = { _: 'mt_p_q_inner_data_temp_dc' };
result.pq = this.bytes();
result.p = this.bytes();
result.q = this.bytes();
result.nonce = this.int128();
...
return result;
  ...
  [3504867164, function() {
const result: any = { _: 'mt_server_DH_params_ok' };
result.nonce = this.int128();
result.server_nonce = this.int128();
...
return result;
  ...
  [3045658042, function() {
const result: any = { _: 'mt_server_DH_inner_data' };
result.nonce = this.int128();
result.server_nonce = this.int128();
result.g = this.int();
...
return result;
  ...
  [1715713620, function() {
const result: any = { _: 'mt_client_DH_inner_data' };
result.nonce = this.int128();
result.server_nonce = this.int128();
...
return result;
  ...
  [1003222836, function() {
const result: any = { _: 'mt_dh_gen_ok' };
result.nonce = this.int128();
result.server_nonce = this.int128();
...
return result;
  ...
  [1188831161, function() {
const result: any = { _: 'mt_dh_gen_retry' };
result.nonce = this.int128();
result.server_nonce = this.int128();
...
return result;
  ...
  [2795351554, function() {
const result: any = { _: 'mt_dh_gen_fail' };
result.nonce = this.int128();
result.server_nonce = this.int128();
...
return result;
  ...
  [1973679973, function() {
const result: any = { _: 'mt_bind_auth_key_inner' };
...
return result;
  ...
  [4082920705, function() {
const result: any = { _: 'mt_rpc_result' };
result.req_msg_id = this.long();
result.result = this.predicate();
return result;
  }],
  [558156313, function() {
const result: any = { _: 'mt_rpc_error' };
result.error_code = this.int();
result.error_message = this.string();
return result;
  }],
  [1579864942, function() {
const result: any = { _: 'mt_rpc_answer_unknown' };
return result;
  }],
  [3447252358, function() {
const result: any = { _: 'mt_rpc_answer_dropped_running' };
return result;
  }],
  [2755319991, function() {
const result: any = { _: 'mt_rpc_answer_dropped' };
...
return result;
  ...
  [155834844, function() {
const result: any = { _: 'mt_future_salt' };
...
return result;
  ...
  [2924480661, function() {
const result: any = { _: 'mt_future_salts' };
result.req_msg_id = this.long();
result.now = this.int();
...
return result;
  ...
  [880243653, function() {
const result: any = { _: 'mt_pong' };
result.msg_id = this.long();
result.ping_id = this.long();
return result;
  }],
  [3793765884, function() {
const result: any = { _: 'mt_destroy_session_ok' };
result.session_id = this.long();
return result;
  }],
  [1658015945, function() {
const result: any = { _: 'mt_destroy_session_none' };
result.session_id = this.long();
return result;
  }],
  [2663516424, function() {
const result: any = { _: 'mt_new_session_created' };
...
return result;
  ...
  [1945237724, function() {
const result: any = { _: 'mt_msg_container' };
result.messages = this.vector(this.mt_message, true);
return result;
  }],
  [1538843921, function() {
const result: any = { _: 'mt_message' };
result.msg_id = this.long();
...
return result;
  ...
  [3764405938, function() {
const result: any = { _: 'mt_msg_copy' };
...
return this.gzip();
  ...
  [1658238041, function() {
const result: any = { _: 'mt_msgs_ack' };
result.msg_ids = this.vector(this.long, false);
return result;
  }],
  [2817521681, function() {
const result: any = { _: 'mt_bad_msg_notification' };
...
return result;
  ...
  [3987424379, function() {
const result: any = { _: 'mt_bad_server_salt' };
result.bad_msg_id = this.long();
result.bad_msg_seqno = this.int();
result.error_code = this.int();
...
return result;
  ...
  [2105940488, function() {
const result: any = { _: 'mt_msg_resend_req' };
result.msg_ids = this.vector(this.long, false);
return result;
  }],
  [3664378706, function() {
const result: any = { _: 'mt_msgs_state_req' };
result.msg_ids = this.vector(this.long, false);
return result;
  }],
  [81704317, function() {
const result: any = { _: 'mt_msgs_state_info' };
result.req_msg_id = this.long();
result.info = this.bytes();
return result;
  }],
  [2361446705, function() {
const result: any = { _: 'mt_msgs_all_info' };
result.msg_ids = this.vector(this.long, false);
result.info = this.bytes();
return result;
  }],
  [661470918, function() {
const result: any = { _: 'mt_msg_detailed_info' };
result.msg_id = this.long();
...
return result;
  ...
  [2157819615, function() {
const result: any = { _: 'mt_msg_new_detailed_info' };
result.answer_msg_id = this.long();
result.bytes = this.int();
result.status = this.int();
return result;
  ...
  [4133544404, function() {
const result: any = { _: 'mt_destroy_auth_key_ok' };
return result;
  }],
  [178201177, function() {
const result: any = { _: 'mt_destroy_auth_key_none' };
return result;
  }],
  [3926956819, function() {
const result: any = { _: 'mt_destroy_auth_key_fail' };
return result;
  }],
  [3162085175, function() {
return false;
...
if (result.flags & 1048576) result.reactions_limit = this.int();
return result;
  }],
  [3224190983, function() {
...
result.offline = !!(result.flags2 & 2);
result.video_processing_pending = !!(result.flags2 & 16);
result.paid_suggested_post_stars = !!(result.flags2 & 256);
result.paid_suggested_post_ton = !!(result.flags2 & 512);
result.id = this.int();
if (result.flags & 256) result.from_id = this.predicate();
if (result.flags & 536870912) result.from_boosts_applied = this.int();
...
if (result.flags2 & 1) result.via_business_bot_id = this.long();
...
if (result.flags & 1073741824) result.quick_reply_shortcut_id = this.int();
if (result.flags2 & 4) result.effect = this.long();
if (result.flags2 & 8) result.factcheck = this.predicate();
if (result.flags2 & 32) result.report_delivery_until_date = this.int();
if (result.flags2 & 64) result.paid_message_stars = this.long();
if (result.flags2 & 128) result.suggested_post = this.predicate();
return result;
  }],
  [2055212554, function() {
...
result.mentioned = !!(result.flags & 16);
result.media_unread = !!(result.flags & 32);
result.reactions_are_possible = !!(result.flags & 512);
result.silent = !!(result.flags & 8192);
result.post = !!(result.flags & 16384);
result.legacy = !!(result.flags & 524288);
result.id = this.int();
...
result.business_bot_paused = !!(result.flags & 2048);
result.business_bot_can_reply = !!(result.flags & 4096);
...
if (result.flags & 8192) result.business_bot_id = this.long();
if (result.flags & 8192) result.business_bot_manage_url = this.string();
if (result.flags & 16384) result.charge_paid_message_stars = this.long();
if (result.flags & 32768) result.registration_month = this.string();
if (result.flags & 65536) result.phone_country = this.string();
if (result.flags & 131072) result.name_change_date = this.int();
if (result.flags & 262144) result.photo_change_date = this.int();
return result;
  }],
  [2755118061, function() {
...
result.contact_require_premium = !!(result.flags & 536870912);
result.read_dates_private = !!(result.flags & 1073741824);
result.flags2 = this.int();
result.sponsored_enabled = !!(result.flags2 & 128);
result.can_view_revenue = !!(result.flags2 & 512);
result.bot_can_manage_emoji_status = !!(result.flags2 & 1024);
result.display_gifts_button = !!(result.flags2 & 65536);
result.id = this.long();
...
if (result.flags & 2048) result.folder_id = this.int();
if (result.flags & 16384) result.ttl_period = this.int();
if (result.flags & 32768) result.theme = this.predicate();
...
if (result.flags2 & 1) result.business_work_hours = this.predicate();
if (result.flags2 & 2) result.business_location = this.predicate();
if (result.flags2 & 4) result.business_greeting_message = this.predicate();
if (result.flags2 & 8) result.business_away_message = this.predicate();
if (result.flags2 & 16) result.business_intro = this.predicate();
if (result.flags2 & 32) result.birthday = this.predicate();
if (result.flags2 & 64) result.personal_channel_id = this.long();
if (result.flags2 & 64) result.personal_channel_message = this.int();
if (result.flags2 & 256) result.stargifts_count = this.int();
if (result.flags2 & 2048) result.starref_program = this.predicate();
if (result.flags2 & 4096) result.bot_verification = this.predicate();
if (result.flags2 & 16384) result.send_paid_messages_stars = this.long();
if (result.flags2 & 32768) result.disallowed_gifts = this.predicate();
if (result.flags2 & 131072) result.stars_rating = this.predicate();
if (result.flags2 & 262144) result.stars_my_pending_rating = this.predicate();
if (result.flags2 & 262144) result.stars_my_pending_rating_date = this.int();
if (result.flags2 & 1048576) result.main_tab = this.predicate();
if (result.flags2 & 2097152) result.saved_music = this.predicate();
return result;
  }],
  [341499403, function() {
...
if (result.flags & 8) result.search_flood = this.predicate();
result.messages = this.vector(this.predicate, false);
result.chats = this.vector(this.predicate, false);
result.users = this.vector(this.predicate, false);
return result;
...
if (result.flags & 1) result.stickers = this.vector(this.predicate);
if (result.flags & 64) result.video_cover = this.predicate();
if (result.flags & 128) result.video_timestamp = this.int();
if (result.flags & 2) result.ttl_seconds = this.int();
return result;
  }],
  [2826320565, function() {
...
result.spoiler = !!(result.flags & 4);
result.id = this.predicate();
if (result.flags & 8) result.video_cover = this.predicate();
if (result.flags & 16) result.video_timestamp = this.int();
if (result.flags & 1) result.ttl_seconds = this.int();
...
if (result.flags & 32) result.alt_documents = this.vector(this.predicate);
if (result.flags & 512) result.video_cover = this.predicate();
if (result.flags & 1024) result.video_timestamp = this.int();
if (result.flags & 4) result.ttl_seconds = this.int();
return result;
  }],
  [1928391342, function() {
...
if (result.flags & 16) result.video_start_ts = this.double();
if (result.flags & 32) result.video_codec = this.string();
return result;
  }],
  [2555574726, function() {
...
result.video_cover_photo = !!(result.flags & 16384);
result.id = this.long();
...
if (result.flags & 1024) result.subscription_expired = this.int();
if (result.flags & 256) result.title = this.string();
if (result.flags & 512) result.subscription_pricing = this.predicate();
return result;
  }],
  [1516793212, function() {
...
result.can_refulfill_subscription = !!(result.flags & 2048);
result.title = this.string();
...
if (result.flags & 1024) result.subscription_pricing = this.predicate();
if (result.flags & 4096) result.subscription_form_id = this.long();
if (result.flags & 8192) result.bot_verification = this.predicate();
return result;
  }],
  [51520707, function() {
...
result.creator = !!(result.flags & 2048);
...
result.contact_require_premium = !!(result.flags2 & 1024);
result.bot_business = !!(result.flags2 & 2048);
result.bot_has_main_app = !!(result.flags2 & 8192);
result.id = this.long();
...
if (result.flags2 & 4096) result.bot_active_users = this.int();
if (result.flags2 & 16384) result.bot_verification_icon = this.long();
if (result.flags2 & 32768) result.send_paid_messages_stars = this.long();
return result;
  }],
  [3262826695, function() {
...
result.flags = this.int();
result.has_preview_medias = !!(result.flags & 64);
...
if (result.flags & 128) result.privacy_policy_url = this.string();
if (result.flags & 256) result.app_settings = this.predicate();
if (result.flags & 512) result.verifier_settings = this.predicate();
return result;
  }],
  [2734311552, function() {
...
result.signature_profiles = !!(result.flags2 & 4096);
result.autotranslation = !!(result.flags2 & 32768);
result.broadcast_messages_allowed = !!(result.flags2 & 65536);
result.monoforum = !!(result.flags2 & 131072);
result.forum_tabs = !!(result.flags2 & 524288);
result.id = this.long();
...
if (result.flags2 & 2048) result.subscription_until_date = this.int();
if (result.flags2 & 8192) result.bot_verification_icon = this.long();
if (result.flags2 & 16384) result.send_paid_messages_stars = this.long();
if (result.flags2 & 262144) result.linked_monoforum_id = this.long();
return result;
  }],
  [399807445, function() {
...
result.restricted_sponsored = !!(result.flags2 & 2048);
result.can_view_revenue = !!(result.flags2 & 4096);
result.paid_media_allowed = !!(result.flags2 & 16384);
result.can_view_stars_revenue = !!(result.flags2 & 32768);
result.paid_reactions_available = !!(result.flags2 & 65536);
result.stargifts_available = !!(result.flags2 & 524288);
result.paid_messages_available = !!(result.flags2 & 1048576);
result.id = this.long();
result.about = this.string();
...
if (result.flags2 & 8192) result.reactions_limit = this.int();
if (result.flags2 & 16) result.stories = this.predicate();
if (result.flags2 & 128) result.wallpaper = this.predicate();
if (result.flags2 & 256) result.boosts_applied = this.int();
if (result.flags2 & 512) result.boosts_unrestrict = this.int();
if (result.flags2 & 1024) result.emojiset = this.predicate();
if (result.flags2 & 131072) result.bot_verification = this.predicate();
if (result.flags2 & 262144) result.stargifts_count = this.int();
if (result.flags2 & 2097152) result.send_paid_messages_stars = this.long();
if (result.flags2 & 4194304) result.main_tab = this.predicate();
return result;
  }],
  [182649427, function() {
...
result.user_id = this.long();
result.date = this.int();
if (result.flags & 1) result.subscription_until_date = this.int();
return result;
  }],
  [1331723247, function() {
...
result.inviter_id = this.long();
result.date = this.int();
if (result.flags & 2) result.subscription_until_date = this.int();
return result;
  }],
  [803602899, function() {
...
if (result.flags & 2) result.saved_peer_id = this.predicate();
...
result.date = this.int();
if (result.flags & 128) result.effect = this.long();
if (result.flags & 256) result.suggested_post = this.predicate();
return result;
  }],
  [2679813636, function() {
...
result.url = this.string();
if (result.flags & 1) result.ttl_seconds = this.int();
if (result.flags & 4) result.video_cover = this.predicate();
if (result.flags & 8) result.video_timestamp = this.int();
return result;
  }],
  [872932635, function() {
...
if (result.flags & 2048) result.subscription_period = this.int();
return result;
  }],
  [1080028941, function() {
...
if (result.flags & 8) result.provider = this.string();
...
if (result.flags & 16) result.subscription_until_date = this.int();
return result;
  }],
  [4138027219, function() {
...
result.video = !!(result.flags & 64);
result.conference_supported = !!(result.flags & 256);
result.id = this.long();
result.access_hash = this.long();
result.date = this.int();
result.admin_id = this.long();
...
if (result.flags & 128) result.custom_parameters = this.predicate();
return result;
  }],
  [1355435489, function() {
...
result.sub_extend = !!(result.flags & 262144);
return result;
  }],
  [511092620, function() {
...
result.question = this.predicate();
...
result.manage_direct_messages = !!(result.flags & 131072);
return result;
  }],
  [2668758040, function() {
...
result.unknown_number = !!(result.flags & 512);
...
result.peer = this.predicate();
result.messages = this.vector(this.int, false);
if (result.flags & 1) result.sent_messages = this.vector(this.int);
return result;
  }],
  [3497176244, function() {
...
result.title_noanimate = !!(result.flags & 268435456);
result.id = this.int();
result.title = this.predicate();
if (result.flags & 33554432) result.emoticon = this.string();
if (result.flags & 134217728) result.color = this.int();
...
result.expires = this.int();
if (result.flags & 8) result.peer = this.predicate();
if (result.flags & 2) result.psa_type = this.string();
if (result.flags & 4) result.psa_message = this.string();
result.pending_suggestions = this.vector(this.string, false);
result.dismissed_suggestions = this.vector(this.string, false);
if (result.flags & 16) result.custom_pending_suggestion = this.predicate();
result.chats = this.vector(this.predicate, false);
result.users = this.vector(this.predicate, false);
return result;
  }],
...
result.hide_read_marks = !!(result.flags & 8);
result.new_noncontact_peers_require_premium = !!(result.flags & 16);
result.display_gifts_button = !!(result.flags & 128);
if (result.flags & 32) result.noncontact_peers_paid_stars = this.long();
if (result.flags & 64) result.disallowed_gifts = this.predicate();
return result;
  }],
  [1667228533, function() {
...
if (result.flags & 2048) result.todo_item_id = this.int();
return result;
  }],
  [2211844034, function() {
...
result.conference = !!(result.flags & 16384);
result.creator = !!(result.flags & 32768);
result.id = this.long();
result.access_hash = this.long();
result.participants_count = this.int();
...
result.version = this.int();
if (result.flags & 65536) result.invite_link = this.string();
return result;
  }],
  [3635053583, function() {
...
result.flags = this.int();
if (result.flags & 1) result.chat_id = this.long();
result.call = this.predicate();
return result;
  }],
  [2658302637, function() {
...
return result;
  ...
  [3286236164, function() {
const result: any = { _: 'chatTheme' };
result.emoticon = this.string();
return result;
  }],
  [3759268292, function() {
const result: any = { _: 'account.chatThemesNotModified' };
return result;
  }],
  [373835863, function() {
const result: any = { _: 'account.chatThemes' };
result.flags = this.int();
result.hash = this.long();
result.themes = this.vector(this.predicate, false);
result.chats = this.vector(this.predicate, false);
result.users = this.vector(this.predicate, false);
if (result.flags & 1) result.next_offset = this.int();
return result;
  }],
  [3105602874, function() {
...
result.can_report = !!(result.flags & 4096);
result.random_id = this.bytes();
result.url = this.string();
result.title = this.string();
result.message = this.string();
if (result.flags & 2) result.entities = this.vector(this.predicate);
if (result.flags & 64) result.photo = this.predicate();
if (result.flags & 16384) result.media = this.predicate();
if (result.flags & 8192) result.color = this.predicate();
result.button_text = this.string();
if (result.flags & 128) result.sponsor_info = this.string();
if (result.flags & 256) result.additional_info = this.string();
if (result.flags & 32768) result.min_display_duration = this.int();
if (result.flags & 32768) result.max_display_duration = this.int();
return result;
  }],
  [4292502893, function() {
...
if (result.flags & 2) result.start_delay = this.int();
if (result.flags & 4) result.between_delay = this.int();
result.messages = this.vector(this.predicate, false);
result.chats = this.vector(this.predicate, false);
result.users = this.vector(this.predicate, false);
return result;
...
result.reactions_as_tags = !!(result.flags & 8);
result.results = this.vector(this.predicate, false);
if (result.flags & 2) result.recent_reactions = this.vector(this.predicate);
if (result.flags & 16) result.top_reactors = this.vector(this.predicate);
return result;
  }],
  [834488621, function() {
...
result.flags = this.int();
result.fullsize = !!(result.flags & 2);
result.fullscreen = !!(result.flags & 4);
if (result.flags & 1) result.query_id = this.long();
result.url = this.string();
return result;
  }],
  [211046684, function() {
...
if (result.flags & 2) result.message = this.predicate();
return result;
  }],
  [3364567810, function() {
...
result.flags = this.int();
result.document_id = this.long();
if (result.flags & 1) result.until = this.int();
return result;
  }],
  [674706841, function() {
...
result.peer = this.predicate();
result.msg_id = this.int();
result.extended_media = this.vector(this.predicate, false);
return result;
  }],
  [4244550300, function() {
...
if (result.flags & 4) result.play_integrity_project_id = this.long();
if (result.flags & 4) result.play_integrity_nonce = this.bytes();
...
result.flags = this.int();
result.title_noanimate = !!(result.flags & 2);
result.title = this.predicate();
...
result.id = this.int();
result.date = this.int();
if (result.flags & 262144) result.from_id = this.predicate();
...
if (result.flags & 524288) result.albums = this.vector(this.int);
return result;
  }],
  [1974712216, function() {
...
if (result.flags & 1) result.pinned_to_top = this.vector(this.int);
result.chats = this.vector(this.predicate, false);
result.users = this.vector(this.predicate, false);
return result;
  }],
...
if (result.flags & 32) result.monoforum_peer_id = this.predicate();
if (result.flags & 64) result.todo_item_id = this.int();
return result;
  }],
  [1484862010, function() {
...
if (result.flags & 1) result.radius = this.double();
return result;
  }],
  [3196246940, function() {
...
result.coordinates = this.predicate();
result.geo = this.predicate();
if (result.flags & 1) result.address = this.predicate();
return result;
  }],
  [2103604867, function() {
...
if (result.flags & 16) result.months = this.int();
if (result.flags & 32) result.stars = this.long();
result.until_date = this.int();
return result;
  }],
  [1456486804, function() {
...
result.unclaimed = !!(result.flags & 32);
...
if (result.flags & 16) result.message = this.predicate();
return result;
  }],
  [2819576292, function() {
const result: any = { _: 'messageActionGiveawayLaunch' };
result.flags = this.int();
if (result.flags & 1) result.stars = this.long();
return result;
  }],
  [1130879648, function() {
...
result.start_date = this.int();
if (result.flags & 8) result.gift_code_slug = this.string();
if (result.flags & 16) result.stars_prize = this.long();
result.finish_date = this.int();
result.winners_count = this.int();
if (result.flags & 4) result.activated_count = this.int();
return result;
  }],
  [4056722092, function() {
const result: any = { _: 'messageEntityBlockquote' };
result.flags = this.int();
result.collapsed = !!(result.flags & 1);
result.offset = this.int();
result.length = this.int();
return result;
  }],
...
if (result.flags & 64) result.stars = this.long();
return result;
  }],
  [2264424764, function() {
...
if (result.flags & 16) result.group_min_level = this.int();
return result;
  }],
  [732034510, function() {
...
return result;
  ...
  [3413112872, function() {
const result: any = { _: 'savedReactionTag' };
result.flags = this.int();
result.reaction = this.predicate();
if (result.flags & 1) result.title = this.string();
result.count = this.int();
return result;
  ...
  [2291882479, function() {
const result: any = { _: 'messages.savedReactionTagsNotModified' };
return result;
  }],
  [844731658, function() {
const result: any = { _: 'messages.savedReactionTags' };
result.tags = this.vector(this.predicate, false);
result.hash = this.long();
return result;
  }],
  [969307186, function() {
const result: any = { _: 'updateSavedReactionTags' };
return result;
  }],
  [1001931436, function() {
const result: any = { _: 'outboxReadDate' };
result.date = this.int();
return result;
  }],
  [3422726765, function() {
const result: any = { _: 'messageActionBoostApply' };
result.boosts = this.int();
return result;
  }],
  [1188577451, function() {
const result: any = { _: 'channelAdminLogEventActionChangeEmojiStickerSet' };
result.prev_stickerset = this.predicate();
result.new_stickerset = this.predicate();
return result;
  }],
  [3700114639, function() {
const result: any = { _: 'smsjobs.eligibleToJoin' };
result.terms_url = this.string();
result.monthly_sent_sms = this.int();
return result;
  }],
  [720277905, function() {
const result: any = { _: 'smsjobs.status' };
result.flags = this.int();
result.allow_international = !!(result.flags & 1);
result.recent_sent = this.int();
result.recent_since = this.int();
result.recent_remains = this.int();
result.total_sent = this.int();
result.total_since = this.int();
if (result.flags & 2) result.last_gift_slug = this.string();
result.terms_url = this.string();
return result;
  }],
  [4049758676, function() {
const result: any = { _: 'updateSmsJob' };
result.job_id = this.string();
return result;
  }],
  [3869372088, function() {
const result: any = { _: 'smsJob' };
result.job_id = this.string();
result.phone_number = this.string();
result.text = this.string();
return result;
  ...
  [302717625, function() {
const result: any = { _: 'businessWeeklyOpen' };
result.start_minute = this.int();
result.end_minute = this.int();
return result;
  }],
  [2358423704, function() {
const result: any = { _: 'businessWorkHours' };
result.flags = this.int();
result.open_now = !!(result.flags & 1);
result.timezone_id = this.string();
result.weekly_open = this.vector(this.predicate, false);
return result;
  }],
  [2891717367, function() {
const result: any = { _: 'businessLocation' };
result.flags = this.int();
if (result.flags & 1) result.geo_point = this.predicate();
result.address = this.string();
return result;
  }],
  [1871393450, function() {
const result: any = { _: 'inputBusinessRecipients' };
result.flags = this.int();
result.existing_chats = !!(result.flags & 1);
result.new_chats = !!(result.flags & 2);
result.contacts = !!(result.flags & 4);
result.non_contacts = !!(result.flags & 8);
result.exclude_selected = !!(result.flags & 32);
if (result.flags & 16) result.users = this.vector(this.predicate);
return result;
  }],
  [554733559, function() {
const result: any = { _: 'businessRecipients' };
result.flags = this.int();
result.existing_chats = !!(result.flags & 1);
result.new_chats = !!(result.flags & 2);
result.contacts = !!(result.flags & 4);
result.non_contacts = !!(result.flags & 8);
result.exclude_selected = !!(result.flags & 32);
if (result.flags & 16) result.users = this.vector(this.long);
return result;
  }],
  [3384402617, function() {
const result: any = { _: 'businessAwayMessageScheduleAlways' };
return result;
  }],
  [3287479553, function() {
const result: any = { _: 'businessAwayMessageScheduleOutsideWorkHours' };
return result;
  }],
  [3427638988, function() {
const result: any = { _: 'businessAwayMessageScheduleCustom' };
result.start_date = this.int();
result.end_date = this.int();
return result;
  }],
  [26528571, function() {
const result: any = { _: 'inputBusinessGreetingMessage' };
result.shortcut_id = this.int();
result.recipients = this.predicate();
result.no_activity_days = this.int();
return result;
  }],
  [3843664811, function() {
const result: any = { _: 'businessGreetingMessage' };
result.shortcut_id = this.int();
result.recipients = this.predicate();
result.no_activity_days = this.int();
return result;
  ...
  [2200008160, function() {
const result: any = { _: 'inputBusinessAwayMessage' };
result.flags = this.int();
result.offline_only = !!(result.flags & 1);
result.shortcut_id = this.int();
result.schedule = this.predicate();
result.recipients = this.predicate();
return result;
  }],
  [4011158108, function() {
const result: any = { _: 'businessAwayMessage' };
result.flags = this.int();
result.offline_only = !!(result.flags & 1);
result.shortcut_id = this.int();
result.schedule = this.predicate();
...
return result;
  ...
  [4287793653, function() {
const result: any = { _: 'timezone' };
result.id = this.string();
result.name = this.string();
result.utc_offset = this.int();
return result;
  }],
  [2533820620, function() {
const result: any = { _: 'help.timezonesListNotModified' };
return result;
  }],
  [2071260529, function() {
const result: any = { _: 'help.timezonesList' };
result.timezones = this.vector(this.predicate, false);
result.hash = this.int();
return result;
  }],
  [110563371, function() {
const result: any = { _: 'quickReply' };
result.shortcut_id = this.int();
result.shortcut = this.string();
result.top_message = this.int();
result.count = this.int();
return result;
  }],
  [609840449, function() {
const result: any = { _: 'inputQuickReplyShortcut' };
result.shortcut = this.string();
return result;
  }],
  [18418929, function() {
const result: any = { _: 'inputQuickReplyShortcutId' };
result.shortcut_id = this.int();
return result;
  }],
  [3331155605, function() {
const result: any = { _: 'messages.quickReplies' };
result.quick_replies = this.vector(this.predicate, false);
result.messages = this.vector(this.predicate, false);
result.chats = this.vector(this.predicate, false);
result.users = this.vector(this.predicate, false);
return result;
  ...
  [1603398491, function() {
const result: any = { _: 'messages.quickRepliesNotModified' };
return result;
  }],
  [4182182578, function() {
const result: any = { _: 'updateQuickReplies' };
result.quick_replies = this.vector(this.predicate, false);
return result;
  }],
  [4114458391, function() {
const result: any = { _: 'updateNewQuickReply' };
result.quick_reply = this.predicate();
return result;
  }],
  [1407644140, function() {
const result: any = { _: 'updateDeleteQuickReply' };
result.shortcut_id = this.int();
return result;
  }],
  [1040518415, function() {
const result: any = { _: 'updateQuickReplyMessage' };
result.message = this.predicate();
return result;
  }],
  [1450174413, function() {
const result: any = { _: 'updateDeleteQuickReplyMessages' };
result.shortcut_id = this.int();
result.messages = this.vector(this.int, false);
return result;
  }],
  [3445908332, function() {
const result: any = { _: 'connectedBot' };
result.flags = this.int();
result.bot_id = this.long();
result.recipients = this.predicate();
result.rights = this.predicate();
return result;
  }],
  [400029819, function() {
const result: any = { _: 'account.connectedBots' };
result.connected_bots = this.vector(this.predicate, false);
result.users = this.vector(this.predicate, false);
return result;
  }],
  [718878489, function() {
const result: any = { _: 'messages.dialogFilters' };
result.flags = this.int();
result.tags_enabled = !!(result.flags & 1);
result.filters = this.vector(this.predicate, false);
return result;
  }],
  [1821253126, function() {
const result: any = { _: 'birthday' };
result.flags = this.int();
result.day = this.int();
result.month = this.int();
if (result.flags & 1) result.year = this.int();
return result;
  }],
  [2330315130, function() {
const result: any = { _: 'updateBotBusinessConnect' };
result.connection = this.predicate();
result.qts = this.int();
return result;
  }],
  [2648388732, function() {
const result: any = { _: 'updateBotNewBusinessMessage' };
result.flags = this.int();
result.connection_id = this.string();
result.message = this.predicate();
if (result.flags & 1) result.reply_to_message = this.predicate();
result.qts = this.int();
return result;
  }],
  [132077692, function() {
const result: any = { _: 'updateBotEditBusinessMessage' };
result.flags = this.int();
result.connection_id = this.string();
result.message = this.predicate();
if (result.flags & 1) result.reply_to_message = this.predicate();
...
return result;
  ...
  [2687146030, function() {
const result: any = { _: 'updateBotDeleteBusinessMessage' };
result.connection_id = this.string();
result.peer = this.predicate();
result.messages = this.vector(this.int, false);
result.qts = this.int();
return result;
  ...
  [2402595573, function() {
const result: any = { _: 'botBusinessConnection' };
result.flags = this.int();
result.disabled = !!(result.flags & 2);
result.connection_id = this.string();
result.user_id = this.long();
result.dc_id = this.int();
result.date = this.int();
if (result.flags & 4) result.rights = this.predicate();
return result;
  }],
  [163867085, function() {
const result: any = { _: 'inputBusinessIntro' };
result.flags = this.int();
result.title = this.string();
result.description = this.string();
if (result.flags & 1) result.sticker = this.predicate();
return result;
  }],
  [1510606445, function() {
const result: any = { _: 'businessIntro' };
result.flags = this.int();
result.title = this.string();
result.description = this.string();
if (result.flags & 1) result.sticker = this.predicate();
return result;
  ...
  [4211040925, function() {
const result: any = { _: 'messages.myStickers' };
result.count = this.int();
result.sets = this.vector(this.predicate, false);
return result;
  }],
  [3818152105, function() {
const result: any = { _: 'inputCollectibleUsername' };
result.username = this.string();
return result;
  }],
  [2732725412, function() {
const result: any = { _: 'inputCollectiblePhone' };
result.phone = this.string();
return result;
  }],
  [1857945489, function() {
const result: any = { _: 'fragment.collectibleInfo' };
result.purchase_date = this.int();
result.currency = this.string();
result.amount = this.long();
...
return result;
  ...
  [3303379486, function() {
const result: any = { _: 'inputBusinessBotRecipients' };
result.flags = this.int();
result.existing_chats = !!(result.flags & 1);
result.new_chats = !!(result.flags & 2);
result.contacts = !!(result.flags & 4);
...
result.exclude_selected = !!(result.flags & 32);
if (result.flags & 16) result.users = this.vector(this.predicate);
if (result.flags & 64) result.exclude_users = this.vector(this.predicate);
return result;
  }],
  [3096245107, function() {
const result: any = { _: 'businessBotRecipients' };
result.flags = this.int();
result.existing_chats = !!(result.flags & 1);
result.new_chats = !!(result.flags & 2);
result.contacts = !!(result.flags & 4);
...
result.exclude_selected = !!(result.flags & 32);
if (result.flags & 16) result.users = this.vector(this.long);
if (result.flags & 64) result.exclude_users = this.vector(this.long);
return result;
  }],
  [496600883, function() {
const result: any = { _: 'contactBirthday' };
result.contact_id = this.long();
result.birthday = this.predicate();
return result;
  }],
  [290452237, function() {
const result: any = { _: 'contacts.contactBirthdays' };
result.contacts = this.vector(this.predicate, false);
result.users = this.vector(this.predicate, false);
return result;
  }],
  [3596227020, function() {
const result: any = { _: 'inputPrivacyKeyBirthday' };
return result;
  }],
  [536913176, function() {
const result: any = { _: 'privacyKeyBirthday' };
return result;
  }],
  [2009975281, function() {
const result: any = { _: 'inputPrivacyValueAllowPremium' };
return result;
  }],
  [3974725963, function() {
const result: any = { _: 'privacyValueAllowPremium' };
return result;
  }],
  [1653379620, function() {
const result: any = { _: 'missingInvitee' };
result.flags = this.int();
result.premium_would_allow_invite = !!(result.flags & 1);
result.premium_required_for_pm = !!(result.flags & 2);
result.user_id = this.long();
return result;
  }],
  [2136862630, function() {
const result: any = { _: 'messages.invitedUsers' };
result.updates = this.predicate();
result.missing_invitees = this.vector(this.predicate, false);
return result;
  }],
  [292003751, function() {
const result: any = { _: 'inputBusinessChatLink' };
result.flags = this.int();
result.message = this.string();
if (result.flags & 1) result.entities = this.vector(this.predicate);
if (result.flags & 2) result.title = this.string();
return result;
  ...
  [3031328367, function() {
const result: any = { _: 'businessChatLink' };
result.flags = this.int();
result.link = this.string();
result.message = this.string();
if (result.flags & 1) result.entities = this.vector(this.predicate);
...
return result;
  ...
  [3963855569, function() {
const result: any = { _: 'account.businessChatLinks' };
result.links = this.vector(this.predicate, false);
result.chats = this.vector(this.predicate, false);
result.users = this.vector(this.predicate, false);
return result;
  }],
  [2586029857, function() {
const result: any = { _: 'account.resolvedBusinessChatLinks' };
result.flags = this.int();
result.peer = this.predicate();
result.message = this.string();
if (result.flags & 1) result.entities = this.vector(this.predicate);
...
return result;
  ...
  [3593466986, function() {
const result: any = { _: 'requestedPeerUser' };
result.flags = this.int();
result.user_id = this.long();
if (result.flags & 1) result.first_name = this.string();
if (result.flags & 1) result.last_name = this.string();
if (result.flags & 2) result.username = this.string();
if (result.flags & 4) result.photo = this.predicate();
return result;
  }],
  [1929860175, function() {
const result: any = { _: 'requestedPeerChat' };
result.flags = this.int();
result.chat_id = this.long();
if (result.flags & 1) result.title = this.string();
if (result.flags & 4) result.photo = this.predicate();
return result;
  ...
  [2342781924, function() {
const result: any = { _: 'requestedPeerChannel' };
result.flags = this.int();
result.channel_id = this.long();
if (result.flags & 1) result.title = this.string();
if (result.flags & 2) result.username = this.string();
...
return result;
  ...
  [2477987912, function() {
const result: any = { _: 'messageActionRequestedPeerSentMe' };
result.button_id = this.int();
result.peers = this.vector(this.predicate, false);
return result;
  }],
  [3378916613, function() {
const result: any = { _: 'inputKeyboardButtonRequestPeer' };
result.flags = this.int();
result.name_requested = !!(result.flags & 1);
result.username_requested = !!(result.flags & 2);
result.photo_requested = !!(result.flags & 4);
result.text = this.string();
result.button_id = this.int();
result.peer_type = this.predicate();
result.max_quantity = this.int();
return result;
  ...
  [1124938064, function() {
const result: any = { _: 'sponsoredMessageReportOption' };
result.text = this.string();
result.option = this.bytes();
return result;
  }],
  [2221907522, function() {
const result: any = { _: 'channels.sponsoredMessageReportResultChooseOption' };
result.title = this.string();
result.options = this.vector(this.predicate, false);
return result;
  }],
  [1044107055, function() {
const result: any = { _: 'channels.sponsoredMessageReportResultAdsHidden' };
return result;
  }],
  [2910423113, function() {
const result: any = { _: 'channels.sponsoredMessageReportResultReported' };
return result;
  }],
  [1355547603, function() {
const result: any = { _: 'webPageAttributeStickerSet' };
result.flags = this.int();
result.emojis = !!(result.flags & 1);
result.text_color = !!(result.flags & 2);
result.stickers = this.vector(this.predicate, false);
return result;
  }],
  [3133384218, function() {
const result: any = { _: 'reactionNotificationsFromContacts' };
return result;
  }],
  [1268654752, function() {
const result: any = { _: 'reactionNotificationsFromAll' };
return result;
  }],
  [1457736048, function() {
const result: any = { _: 'reactionsNotifySettings' };
result.flags = this.int();
if (result.flags & 1) result.messages_notify_from = this.predicate();
if (result.flags & 2) result.stories_notify_from = this.predicate();
result.sound = this.predicate();
result.show_previews = this.predicate();
return result;
  }],
  [405070859, function() {
const result: any = { _: 'updateNewStoryReaction' };
result.story_id = this.int();
result.peer = this.predicate();
result.reaction = this.predicate();
return result;
  ...
  [2752949377, function() {
const result: any = { _: 'auth.sentCodeTypeSmsWord' };
result.flags = this.int();
if (result.flags & 1) result.beginning = this.string();
return result;
  }],
  [3010958511, function() {
const result: any = { _: 'auth.sentCodeTypeSmsPhrase' };
result.flags = this.int();
if (result.flags & 1) result.beginning = this.string();
return result;
  }],
  [2161274055, function() {
const result: any = { _: 'emojiGroupGreeting' };
result.title = this.string();
result.icon_emoji_id = this.long();
result.emoticons = this.vector(this.string, false);
return result;
  ...
  [154914612, function() {
const result: any = { _: 'emojiGroupPremium' };
result.title = this.string();
result.icon_emoji_id = this.long();
return result;
  }],
  [2479088254, function() {
const result: any = { _: 'availableEffect' };
result.flags = this.int();
result.premium_required = !!(result.flags & 4);
result.id = this.long();
result.emoticon = this.string();
if (result.flags & 1) result.static_icon_id = this.long();
result.effect_sticker_id = this.long();
if (result.flags & 2) result.effect_animation_id = this.long();
return result;
  }],
  [3522009691, function() {
const result: any = { _: 'messages.availableEffectsNotModified' };
return result;
  }],
  [3185271150, function() {
const result: any = { _: 'messages.availableEffects' };
result.hash = this.int();
result.effects = this.vector(this.predicate, false);
result.documents = this.vector(this.predicate, false);
return result;
  }],
  [3097230543, function() {
const result: any = { _: 'factCheck' };
result.flags = this.int();
result.need_check = !!(result.flags & 1);
if (result.flags & 2) result.country = this.string();
if (result.flags & 2) result.text = this.predicate();
result.hash = this.long();
return result;
  }],
  [2515714020, function() {
const result: any = { _: 'starsTransactionPeerUnsupported' };
return result;
  }],
  [3025646453, function() {
const result: any = { _: 'starsTransactionPeerAppStore' };
return result;
  }],
  [2069236235, function() {
const result: any = { _: 'starsTransactionPeerPlayMarket' };
return result;
  }],
  [621656824, function() {
const result: any = { _: 'starsTransactionPeerPremiumBot' };
return result;
  }],
  [3912227074, function() {
const result: any = { _: 'starsTransactionPeerFragment' };
return result;
  }],
  [3624771933, function() {
const result: any = { _: 'starsTransactionPeer' };
result.peer = this.predicate();
return result;
  }],
  [198776256, function() {
const result: any = { _: 'starsTopupOption' };
result.flags = this.int();
result.extended = !!(result.flags & 2);
result.stars = this.long();
if (result.flags & 1) result.store_product = this.string();
result.currency = this.string();
result.amount = this.long();
return result;
  ...
  [1710230755, function() {
const result: any = { _: 'inputInvoiceStars' };
result.purpose = this.predicate();
return result;
  }],
  [325426864, function() {
const result: any = { _: 'starsTransaction' };
result.flags = this.int();
result.refund = !!(result.flags & 8);
result.pending = !!(result.flags & 16);
result.failed = !!(result.flags & 64);
result.gift = !!(result.flags & 1024);
result.reaction = !!(result.flags & 2048);
result.stargift_upgrade = !!(result.flags & 262144);
result.business_transfer = !!(result.flags & 2097152);
result.stargift_resale = !!(result.flags & 4194304);
result.posts_search = !!(result.flags & 16777216);
result.stargift_prepaid_upgrade = !!(result.flags & 33554432);
result.id = this.string();
result.amount = this.predicate();
result.date = this.int();
result.peer = this.predicate();
if (result.flags & 1) result.title = this.string();
if (result.flags & 2) result.description = this.string();
if (result.flags & 4) result.photo = this.predicate();
if (result.flags & 32) result.transaction_date = this.int();
if (result.flags & 32) result.transaction_url = this.string();
if (result.flags & 128) result.bot_payload = this.bytes();
if (result.flags & 256) result.msg_id = this.int();
if (result.flags & 512) result.extended_media = this.vector(this.predicate);
if (result.flags & 4096) result.subscription_period = this.int();
if (result.flags & 8192) result.giveaway_post_id = this.int();
if (result.flags & 16384) result.stargift = this.predicate();
if (result.flags & 32768) result.floodskip_number = this.int();
if (result.flags & 65536) result.starref_commission_permille = this.int();
if (result.flags & 131072) result.starref_peer = this.predicate();
if (result.flags & 131072) result.starref_amount = this.predicate();
if (result.flags & 524288) result.paid_messages = this.int();
if (result.flags & 1048576) result.premium_gift_months = this.int();
if (result.flags & 8388608) result.ads_proceeds_from_date = this.int();
if (result.flags & 8388608) result.ads_proceeds_to_date = this.int();
return result;
  }],
  [1822222573, function() {
const result: any = { _: 'payments.starsStatus' };
result.flags = this.int();
result.balance = this.predicate();
if (result.flags & 2) result.subscriptions = this.vector(this.predicate);
if (result.flags & 4) result.subscriptions_next_offset = this.string();
if (result.flags & 16) result.subscriptions_missing_balance = this.long();
if (result.flags & 8) result.history = this.vector(this.predicate);
if (result.flags & 1) result.next_offset = this.string();
result.chats = this.vector(this.predicate, false);
result.users = this.vector(this.predicate, false);
return result;
  ...
  [1317053305, function() {
const result: any = { _: 'updateStarsBalance' };
result.balance = this.predicate();
return result;
  }],
  [2079764828, function() {
const result: any = { _: 'payments.paymentFormStars' };
result.flags = this.int();
result.form_id = this.long();
result.bot_id = this.long();
result.title = this.string();
...
return result;
  ...
  [3669751866, function() {
const result: any = { _: 'payments.paymentReceiptStars' };
result.flags = this.int();
result.date = this.int();
result.bot_id = this.long();
result.title = this.string();
...
result.currency = this.string();
result.total_amount = this.long();
result.transaction_id = this.string();
result.users = this.vector(this.predicate, false);
return result;
  }],
  [926421125, function() {
const result: any = { _: 'mediaAreaUrl' };
result.coordinates = this.predicate();
result.url = this.string();
return result;
  }],
  [3900361664, function() {
const result: any = { _: 'foundStory' };
result.peer = this.predicate();
result.story = this.predicate();
return result;
  }],
  [3806230327, function() {
const result: any = { _: 'stories.foundStories' };
result.flags = this.int();
result.count = this.int();
result.stories = this.vector(this.predicate, false);
if (result.flags & 1) result.next_offset = this.string();
...
return result;
  ...
  [3729546643, function() {
const result: any = { _: 'geoPointAddress' };
result.flags = this.int();
result.country_iso2 = this.string();
if (result.flags & 1) result.state = this.string();
if (result.flags & 2) result.city = this.string();
if (result.flags & 4) result.street = this.string();
return result;
  }],
  [513998247, function() {
const result: any = { _: 'updateBusinessBotCallbackQuery' };
result.flags = this.int();
result.query_id = this.long();
result.user_id = this.long();
result.connection_id = this.string();
result.message = this.predicate();
if (result.flags & 4) result.reply_to_message = this.predicate();
result.chat_instance = this.long();
if (result.flags & 1) result.data = this.bytes();
return result;
  }],
  [4273886353, function() {
const result: any = { _: 'starsRevenueStatus' };
result.flags = this.int();
result.withdrawal_enabled = !!(result.flags & 1);
result.current_balance = this.predicate();
result.available_balance = this.predicate();
result.overall_revenue = this.predicate();
if (result.flags & 2) result.next_withdrawal_at = this.int();
return result;
  }],
  [1814066038, function() {
const result: any = { _: 'payments.starsRevenueStats' };
result.flags = this.int();
if (result.flags & 1) result.top_hours_graph = this.predicate();
result.revenue_graph = this.predicate();
result.status = this.predicate();
result.usd_rate = this.double();
return result;
  }],
  [497778871, function() {
const result: any = { _: 'payments.starsRevenueWithdrawalUrl' };
result.url = this.string();
return result;
  }],
  [2776936473, function() {
const result: any = { _: 'updateStarsRevenueStatus' };
result.peer = this.predicate();
result.status = this.predicate();
return result;
  }],
  [3289396102, function() {
const result: any = { _: 'inputMediaPaidMedia' };
result.flags = this.int();
result.stars_amount = this.long();
result.extended_media = this.vector(this.predicate, false);
if (result.flags & 1) result.payload = this.string();
return result;
  }],
  [2827297937, function() {
const result: any = { _: 'messageMediaPaidMedia' };
result.stars_amount = this.long();
result.extended_media = this.vector(this.predicate, false);
return result;
  }],
  [1617438738, function() {
const result: any = { _: 'starsTransactionPeerAds' };
return result;
  }],
  [961445665, function() {
const result: any = { _: 'payments.starsRevenueAdsAccountUrl' };
result.url = this.string();
return result;
  }],
  [543876817, function() {
const result: any = { _: 'inputStarsTransaction' };
result.flags = this.int();
result.refund = !!(result.flags & 1);
result.id = this.string();
return result;
  }],
  [1102307842, function() {
const result: any = { _: 'messageActionPaymentRefunded' };
result.flags = this.int();
result.peer = this.predicate();
result.currency = this.string();
result.total_amount = this.long();
if (result.flags & 1) result.payload = this.bytes();
result.charge = this.predicate();
return result;
  }],
  [4188186315, function() {
const result: any = { _: 'inputStorePaymentStarsTopup' };
result.flags = this.int();
result.stars = this.long();
result.currency = this.string();
result.amount = this.long();
if (result.flags & 1) result.spend_purpose_peer = this.predicate();
return result;
  }],
  [494149367, function() {
const result: any = { _: 'inputStorePaymentStarsGift' };
result.user_id = this.predicate();
result.stars = this.long();
result.currency = this.string();
result.amount = this.long();
return result;
  ...
  [1577421297, function() {
const result: any = { _: 'starsGiftOption' };
result.flags = this.int();
result.extended = !!(result.flags & 2);
result.stars = this.long();
if (result.flags & 1) result.store_product = this.string();
...
return result;
  ...
  [1171632161, function() {
const result: any = { _: 'messageActionGiftStars' };
result.flags = this.int();
result.currency = this.string();
result.amount = this.long();
result.stars = this.long();
if (result.flags & 1) result.crypto_currency = this.string();
if (result.flags & 1) result.crypto_amount = this.long();
if (result.flags & 2) result.transaction_id = this.string();
return result;
  }],
  [4255022060, function() {
const result: any = { _: 'topPeerCategoryBotsApp' };
return result;
  }],
  [428978491, function() {
const result: any = { _: 'bots.popularAppBots' };
result.flags = this.int();
if (result.flags & 1) result.next_offset = this.string();
result.users = this.vector(this.predicate, false);
return result;
  ...
  [602479523, function() {
const result: any = { _: 'botPreviewMedia' };
result.date = this.int();
result.media = this.predicate();
return result;
  }],
  [212278628, function() {
const result: any = { _: 'bots.previewInfo' };
result.media = this.vector(this.predicate, false);
result.lang_codes = this.vector(this.string, false);
return result;
  }],
  [1235637404, function() {
const result: any = { _: 'mediaAreaWeather' };
result.coordinates = this.predicate();
result.emoji = this.string();
result.temperature_c = this.double();
result.color = this.int();
return result;
  }],
  [1658620744, function() {
const result: any = { _: 'inputFileStoryDocument' };
result.id = this.predicate();
return result;
  }],
  [887591921, function() {
const result: any = { _: 'inputInvoiceChatInviteSubscription' };
result.hash = this.string();
return result;
  }],
  [88173912, function() {
const result: any = { _: 'starsSubscriptionPricing' };
result.period = this.int();
result.amount = this.long();
return result;
  }],
  [779004698, function() {
const result: any = { _: 'starsSubscription' };
result.flags = this.int();
result.canceled = !!(result.flags & 1);
result.can_refulfill = !!(result.flags & 2);
result.missing_balance = !!(result.flags & 4);
result.bot_canceled = !!(result.flags & 128);
result.id = this.string();
result.peer = this.predicate();
result.until_date = this.int();
result.pricing = this.predicate();
if (result.flags & 8) result.chat_invite_hash = this.string();
if (result.flags & 16) result.title = this.string();
if (result.flags & 32) result.photo = this.predicate();
if (result.flags & 64) result.invoice_slug = this.string();
return result;
  }],
  [1379771627, function() {
const result: any = { _: 'reactionPaid' };
return result;
  }],
  [1269016922, function() {
const result: any = { _: 'messageReactor' };
result.flags = this.int();
result.top = !!(result.flags & 1);
result.my = !!(result.flags & 2);
result.anonymous = !!(result.flags & 4);
if (result.flags & 8) result.peer_id = this.predicate();
result.count = this.int();
return result;
  }],
  [1621597305, function() {
const result: any = { _: 'channelAdminLogEventActionToggleSignatureProfiles' };
result.new_value = this.predicate();
return result;
  }],
  [675009298, function() {
const result: any = { _: 'updateBotPurchasedPaidMedia' };
result.user_id = this.long();
result.payload = this.string();
result.qts = this.int();
return result;
  }],
  [1684286899, function() {
const result: any = { _: 'channelAdminLogEventActionParticipantSubExtend' };
result.prev_participant = this.predicate();
result.new_participant = this.predicate();
return result;
  }],
  [1964968186, function() {
const result: any = { _: 'inputStorePaymentStarsGiveaway' };
result.flags = this.int();
result.only_new_subscribers = !!(result.flags & 1);
result.winners_are_visible = !!(result.flags & 8);
result.stars = this.long();
...
return result;
  ...
  [2953594786, function() {
const result: any = { _: 'messageActionPrizeStars' };
result.flags = this.int();
result.unclaimed = !!(result.flags & 1);
result.stars = this.long();
result.transaction_id = this.string();
result.boost_peer = this.predicate();
result.giveaway_msg_id = this.int();
return result;
  }],
  [2339528654, function() {
const result: any = { _: 'updatePaidReactionPrivacy' };
result.private = this.predicate();
return result;
  }],
  [2496562474, function() {
const result: any = { _: 'starsGiveawayOption' };
result.flags = this.int();
result.extended = !!(result.flags & 1);
result.default = !!(result.flags & 2);
result.stars = this.long();
result.yearly_boosts = this.int();
if (result.flags & 4) result.store_product = this.string();
result.currency = this.string();
result.amount = this.long();
result.winners = this.vector(this.predicate, false);
return result;
  }],
  [1411605001, function() {
const result: any = { _: 'starsGiveawayWinnersOption' };
result.flags = this.int();
result.default = !!(result.flags & 1);
result.users = this.int();
result.per_user_stars = this.long();
return result;
  }],
  [2594011104, function() {
const result: any = { _: 'prepaidStarsGiveaway' };
result.id = this.long();
result.stars = this.long();
result.quantity = this.int();
result.boosts = this.int();
...
return result;
  ...
  [1976723854, function() {
const result: any = { _: 'keyboardButtonCopy' };
result.text = this.string();
result.copy_text = this.string();
return result;
  }],
  [2158777283, function() {
const result: any = { _: 'starGift' };
result.flags = this.int();
result.limited = !!(result.flags & 1);
result.sold_out = !!(result.flags & 2);
result.birthday = !!(result.flags & 4);
result.require_premium = !!(result.flags & 128);
result.limited_per_user = !!(result.flags & 256);
result.id = this.long();
result.sticker = this.predicate();
result.stars = this.long();
if (result.flags & 1) result.availability_remains = this.int();
if (result.flags & 1) result.availability_total = this.int();
if (result.flags & 16) result.availability_resale = this.long();
result.convert_stars = this.long();
if (result.flags & 2) result.first_sale_date = this.int();
if (result.flags & 2) result.last_sale_date = this.int();
if (result.flags & 8) result.upgrade_stars = this.long();
if (result.flags & 16) result.resell_min_stars = this.long();
if (result.flags & 32) result.title = this.string();
if (result.flags & 64) result.released_by = this.predicate();
if (result.flags & 256) result.per_user_total = this.int();
if (result.flags & 256) result.per_user_remains = this.int();
if (result.flags & 512) result.locked_until_date = this.int();
return result;
  }],
  [2743640936, function() {
const result: any = { _: 'payments.starGiftsNotModified' };
return result;
  }],
  [785918357, function() {
const result: any = { _: 'payments.starGifts' };
result.hash = this.int();
result.gifts = this.vector(this.predicate, false);
result.chats = this.vector(this.predicate, false);
result.users = this.vector(this.predicate, false);
return result;
  }],
  [3898760850, function() {
const result: any = { _: 'inputInvoiceStarGift' };
result.flags = this.int();
result.hide_name = !!(result.flags & 1);
result.include_upgrade = !!(result.flags & 4);
result.peer = this.predicate();
result.gift_id = this.long();
if (result.flags & 2) result.message = this.predicate();
return result;
  }],
  [3022376929, function() {
const result: any = { _: 'payments.paymentFormStarGift' };
result.form_id = this.long();
result.invoice = this.predicate();
return result;
  }],
  [4065191930, function() {
const result: any = { _: 'messageActionStarGift' };
result.flags = this.int();
result.name_hidden = !!(result.flags & 1);
result.saved = !!(result.flags & 4);
result.converted = !!(result.flags & 8);
result.upgraded = !!(result.flags & 32);
result.refunded = !!(result.flags & 512);
result.can_upgrade = !!(result.flags & 1024);
result.prepaid_upgrade = !!(result.flags & 8192);
result.upgrade_separate = !!(result.flags & 65536);
result.gift = this.predicate();
if (result.flags & 2) result.message = this.predicate();
if (result.flags & 16) result.convert_stars = this.long();
if (result.flags & 32) result.upgrade_msg_id = this.int();
if (result.flags & 256) result.upgrade_stars = this.long();
if (result.flags & 2048) result.from_id = this.predicate();
if (result.flags & 4096) result.peer = this.predicate();
if (result.flags & 4096) result.saved_id = this.long();
if (result.flags & 16384) result.prepaid_upgrade_hash = this.string();
if (result.flags & 32768) result.gift_msg_id = this.int();
return result;
  }],
  [2030298073, function() {
const result: any = { _: 'messageReportOption' };
result.text = this.string();
result.option = this.bytes();
return result;
  }],
  [4041531574, function() {
const result: any = { _: 'reportResultChooseOption' };
result.title = this.string();
result.options = this.vector(this.predicate, false);
return result;
  }],
  [1862904881, function() {
const result: any = { _: 'reportResultAddComment' };
result.flags = this.int();
result.optional = !!(result.flags & 1);
result.option = this.bytes();
return result;
  }],
  [2377333835, function() {
const result: any = { _: 'reportResultReported' };
return result;
  }],
  [4184308397, function() {
const result: any = { _: 'starsTransactionPeerAPI' };
return result;
  }],
  [2395931921, function() {
const result: any = { _: 'messages.botPreparedInlineMessage' };
result.id = this.string();
result.expire_date = this.int();
return result;
  }],
  [4283920525, function() {
const result: any = { _: 'messages.preparedInlineMessage' };
result.query_id = this.long();
result.result = this.predicate();
...
return result;
  ...
  [3382384976, function() {
const result: any = { _: 'botAppSettings' };
result.flags = this.int();
if (result.flags & 1) result.placeholder_path = this.bytes();
if (result.flags & 2) result.background_color = this.int();
if (result.flags & 4) result.background_dark_color = this.int();
if (result.flags & 8) result.header_color = this.int();
if (result.flags & 16) result.header_dark_color = this.int();
return result;
  }],
  [1515179237, function() {
const result: any = { _: 'inputPrivacyValueAllowBots' };
return result;
  }],
  [3303373077, function() {
const result: any = { _: 'inputPrivacyValueDisallowBots' };
return result;
  }],
  [558242653, function() {
const result: any = { _: 'privacyValueAllowBots' };
return result;
  }],
  [4138072111, function() {
const result: any = { _: 'privacyValueDisallowBots' };
return result;
  }],
  [3782419265, function() {
const result: any = { _: 'inputPrivacyKeyStarGiftsAutoSave' };
return result;
  }],
  [749010424, function() {
const result: any = { _: 'privacyKeyStarGiftsAutoSave' };
return result;
  }],
  [3708577522, function() {
const result: any = { _: 'starRefProgram' };
result.flags = this.int();
result.bot_id = this.long();
result.commission_permille = this.int();
if (result.flags & 1) result.duration_months = this.int();
if (result.flags & 2) result.end_date = this.int();
if (result.flags & 4) result.daily_revenue_per_user = this.predicate();
return result;
  }],
  [429997937, function() {
const result: any = { _: 'connectedBotStarRef' };
result.flags = this.int();
result.revoked = !!(result.flags & 2);
result.url = this.string();
result.date = this.int();
result.bot_id = this.long();
result.commission_permille = this.int();
if (result.flags & 1) result.duration_months = this.int();
result.participants = this.long();
result.revenue = this.long();
return result;
  }],
  [2564155933, function() {
const result: any = { _: 'payments.connectedStarRefBots' };
result.count = this.int();
result.connected_bots = this.vector(this.predicate, false);
result.users = this.vector(this.predicate, false);
return result;
  ...
  [3033913433, function() {
const result: any = { _: 'payments.suggestedStarRefBots' };
result.flags = this.int();
result.count = this.int();
result.suggested_bots = this.vector(this.predicate, false);
result.users = this.vector(this.predicate, false);
if (result.flags & 1) result.next_offset = this.string();
return result;
  }],
  [3149313187, function() {
const result: any = { _: 'starsAmount' };
result.amount = this.long();
result.nanos = this.int();
return result;
  }],
  [1611711796, function() {
const result: any = { _: 'messages.foundStickersNotModified' };
result.flags = this.int();
if (result.flags & 1) result.next_offset = this.int();
return result;
  }],
  [2194268816, function() {
const result: any = { _: 'messages.foundStickers' };
result.flags = this.int();
if (result.flags & 1) result.next_offset = this.int();
result.hash = this.long();
result.stickers = this.vector(this.predicate, false);
return result;
  ...
  [2966251031, function() {
const result: any = { _: 'botVerifierSettings' };
result.flags = this.int();
result.can_modify_custom_description = !!(result.flags & 2);
result.icon = this.long();
result.company = this.string();
if (result.flags & 1) result.custom_description = this.string();
return result;
  }],
  [4181513308, function() {
const result: any = { _: 'botVerification' };
result.bot_id = this.long();
result.icon = this.long();
result.description = this.string();
return result;
  ...
  [970559507, function() {
const result: any = { _: 'starGiftAttributeModel' };
result.name = this.string();
result.document = this.predicate();
result.rarity_permille = this.int();
return result;
  }],
  [330104601, function() {
const result: any = { _: 'starGiftAttributePattern' };
result.name = this.string();
result.document = this.predicate();
result.rarity_permille = this.int();
return result;
  ...
  [3644687772, function() {
const result: any = { _: 'starGiftAttributeBackdrop' };
result.name = this.string();
result.backdrop_id = this.int();
result.center_color = this.int();
result.edge_color = this.int();
result.pattern_color = this.int();
result.text_color = this.int();
result.rarity_permille = this.int();
return result;
  }],
  [3770675820, function() {
const result: any = { _: 'starGiftAttributeOriginalDetails' };
result.flags = this.int();
if (result.flags & 1) result.sender_id = this.predicate();
result.recipient_id = this.predicate();
result.date = this.int();
if (result.flags & 2) result.message = this.predicate();
return result;
  }],
  [468707429, function() {
const result: any = { _: 'starGiftUnique' };
result.flags = this.int();
result.require_premium = !!(result.flags & 64);
result.resale_ton_only = !!(result.flags & 128);
result.theme_available = !!(result.flags & 512);
result.id = this.long();
result.gift_id = this.long();
result.title = this.string();
result.slug = this.string();
result.num = this.int();
if (result.flags & 1) result.owner_id = this.predicate();
if (result.flags & 2) result.owner_name = this.string();
if (result.flags & 4) result.owner_address = this.string();
result.attributes = this.vector(this.predicate, false);
result.availability_issued = this.int();
result.availability_total = this.int();
if (result.flags & 8) result.gift_address = this.string();
if (result.flags & 16) result.resell_amount = this.vector(this.predicate);
if (result.flags & 32) result.released_by = this.predicate();
if (result.flags & 256) result.value_amount = this.long();
if (result.flags & 256) result.value_currency = this.string();
if (result.flags & 1024) result.theme_peer = this.predicate();
return result;
  }],
  [888627955, function() {
const result: any = { _: 'messageActionStarGiftUnique' };
result.flags = this.int();
result.upgrade = !!(result.flags & 1);
result.transferred = !!(result.flags & 2);
result.saved = !!(result.flags & 4);
result.refunded = !!(result.flags & 32);
result.prepaid_upgrade = !!(result.flags & 2048);
result.gift = this.predicate();
if (result.flags & 8) result.can_export_at = this.int();
if (result.flags & 16) result.transfer_stars = this.long();
if (result.flags & 64) result.from_id = this.predicate();
if (result.flags & 128) result.peer = this.predicate();
if (result.flags & 128) result.saved_id = this.long();
if (result.flags & 256) result.resale_amount = this.predicate();
if (result.flags & 512) result.can_transfer_at = this.int();
if (result.flags & 1024) result.can_resell_at = this.int();
return result;
  }],
  [1300335965, function() {
const result: any = { _: 'inputInvoiceStarGiftUpgrade' };
result.flags = this.int();
result.keep_original_details = !!(result.flags & 1);
result.stargift = this.predicate();
return result;
  }],
  [1247763417, function() {
const result: any = { _: 'inputInvoiceStarGiftTransfer' };
result.stargift = this.predicate();
result.to_id = this.predicate();
return result;
  }],
  [377215243, function() {
const result: any = { _: 'payments.starGiftUpgradePreview' };
result.sample_attributes = this.vector(this.predicate, false);
return result;
  }],
  [1658259128, function() {
const result: any = { _: 'users.users' };
result.users = this.vector(this.predicate, false);
return result;
  }],
  [828000628, function() {
const result: any = { _: 'users.usersSlice' };
result.count = this.int();
result.users = this.vector(this.predicate, false);
return result;
  }],
  [1097619176, function() {
const result: any = { _: 'payments.uniqueStarGift' };
result.gift = this.predicate();
result.chats = this.vector(this.predicate, false);
result.users = this.vector(this.predicate, false);
return result;
  ...
  [3480186296, function() {
const result: any = { _: 'webPageAttributeUniqueStarGift' };
result.gift = this.predicate();
return result;
  }],
  [1468491885, function() {
const result: any = { _: 'mediaAreaStarGift' };
result.coordinates = this.predicate();
result.slug = this.string();
return result;
  }],
  [2358937772, function() {
const result: any = { _: 'messages.webPagePreview' };
result.media = this.predicate();
result.chats = this.vector(this.predicate, false);
result.users = this.vector(this.predicate, false);
return result;
  ...
  [1904500795, function() {
const result: any = { _: 'emojiStatusCollectible' };
result.flags = this.int();
result.collectible_id = this.long();
result.document_id = this.long();
result.title = this.string();
result.slug = this.string();
result.pattern_document_id = this.long();
result.center_color = this.int();
result.edge_color = this.int();
result.pattern_color = this.int();
result.text_color = this.int();
...
return result;
  ...
  [118758847, function() {
const result: any = { _: 'inputEmojiStatusCollectible' };
result.flags = this.int();
result.collectible_id = this.long();
if (result.flags & 1) result.until = this.int();
return result;
  ...
  [430552434, function() {
const result: any = { _: 'savedStarGift' };
result.flags = this.int();
result.name_hidden = !!(result.flags & 1);
result.unsaved = !!(result.flags & 32);
result.refunded = !!(result.flags & 512);
result.can_upgrade = !!(result.flags & 1024);
result.pinned_to_top = !!(result.flags & 4096);
result.upgrade_separate = !!(result.flags & 131072);
if (result.flags & 2) result.from_id = this.predicate();
result.date = this.int();
result.gift = this.predicate();
if (result.flags & 4) result.message = this.predicate();
if (result.flags & 8) result.msg_id = this.int();
if (result.flags & 2048) result.saved_id = this.long();
if (result.flags & 16) result.convert_stars = this.long();
if (result.flags & 64) result.upgrade_stars = this.long();
if (result.flags & 128) result.can_export_at = this.int();
if (result.flags & 256) result.transfer_stars = this.long();
if (result.flags & 8192) result.can_transfer_at = this.int();
if (result.flags & 16384) result.can_resell_at = this.int();
if (result.flags & 32768) result.collection_id = this.vector(this.int);
if (result.flags & 65536) result.prepaid_upgrade_hash = this.string();
return result;
  }],
  [2515765681, function() {
const result: any = { _: 'payments.savedStarGifts' };
result.flags = this.int();
result.count = this.int();
if (result.flags & 2) result.chat_notifications_enabled = this.predicate();
result.gifts = this.vector(this.predicate, false);
if (result.flags & 1) result.next_offset = this.string();
result.chats = this.vector(this.predicate, false);
result.users = this.vector(this.predicate, false);
return result;
  ...
  [1764202389, function() {
const result: any = { _: 'inputSavedStarGiftUser' };
result.msg_id = this.int();
return result;
  }],
  [4043418239, function() {
const result: any = { _: 'inputSavedStarGiftChat' };
result.peer = this.predicate();
result.saved_id = this.long();
return result;
  }],
  [2225748636, function() {
const result: any = { _: 'payments.starGiftWithdrawalUrl' };
result.url = this.string();
return result;
  }],
  [543872158, function() {
const result: any = { _: 'paidReactionPrivacyDefault' };
return result;
  }],
  [520887001, function() {
const result: any = { _: 'paidReactionPrivacyAnonymous' };
return result;
  }],
  [3698130160, function() {
const result: any = { _: 'paidReactionPrivacyPeer' };
result.peer = this.predicate();
return result;
  }],
  [3183843252, function() {
const result: any = { _: 'inputPrivacyKeyNoPaidMessages' };
return result;
  }],
  [399722706, function() {
const result: any = { _: 'privacyKeyNoPaidMessages' };
return result;
  }],
  [504403720, function() {
const result: any = { _: 'account.paidMessagesRevenue' };
result.stars_amount = this.long();
return result;
  }],
  [84580409, function() {
const result: any = { _: 'requirementToContactEmpty' };
return result;
  }],
  [3850495209, function() {
const result: any = { _: 'requirementToContactPremium' };
return result;
  }],
  [3036053139, function() {
const result: any = { _: 'requirementToContactPaidMessages' };
result.stars_amount = this.long();
return result;
  }],
  [3669668591, function() {
const result: any = { _: 'inputInvoicePremiumGiftStars' };
result.flags = this.int();
result.user_id = this.predicate();
result.months = this.int();
if (result.flags & 1) result.message = this.predicate();
return result;
  }],
  [3617783033, function() {
const result: any = { _: 'auth.sentCodePaymentRequired' };
result.store_product = this.string();
result.phone_code_hash = this.string();
result.support_email_address = this.string();
result.support_email_subject = this.string();
return result;
  }],
  [2612159341, function() {
const result: any = { _: 'inputStorePaymentAuthCode' };
result.flags = this.int();
result.restore = !!(result.flags & 1);
result.phone_number = this.string();
result.phone_code_hash = this.string();
...
return result;
  ...
  [1347068303, function() {
const result: any = { _: 'updateSentPhoneCode' };
result.sent_code = this.predicate();
return result;
  }],
  [2690796791, function() {
const result: any = { _: 'businessBotRights' };
result.flags = this.int();
result.reply = !!(result.flags & 1);
result.read_messages = !!(result.flags & 2);
result.delete_sent_messages = !!(result.flags & 4);
result.delete_received_messages = !!(result.flags & 8);
result.edit_name = !!(result.flags & 16);
result.edit_bio = !!(result.flags & 32);
result.edit_profile_photo = !!(result.flags & 64);
result.edit_username = !!(result.flags & 128);
result.view_gifts = !!(result.flags & 256);
result.sell_gifts = !!(result.flags & 512);
result.change_gift_settings = !!(result.flags & 1024);
result.transfer_and_upgrade_gifts = !!(result.flags & 2048);
result.transfer_stars = !!(result.flags & 4096);
result.manage_stories = !!(result.flags & 8192);
return result;
  }],
  [2887720909, function() {
const result: any = { _: 'messageActionPaidMessagesRefunded' };
result.count = this.int();
result.stars = this.long();
return result;
  }],
  [2226685304, function() {
const result: any = { _: 'messageActionPaidMessagesPrice' };
result.flags = this.int();
result.broadcast_messages_allowed = !!(result.flags & 1);
result.stars = this.long();
return result;
  }],
  [1911715524, function() {
const result: any = { _: 'disallowedGiftsSettings' };
result.flags = this.int();
result.disallow_unlimited_stargifts = !!(result.flags & 1);
result.disallow_limited_stargifts = !!(result.flags & 2);
result.disallow_unique_stargifts = !!(result.flags & 4);
result.disallow_premium_gifts = !!(result.flags & 8);
return result;
  }],
  [3331786963, function() {
const result: any = { _: 'sponsoredPeer' };
result.flags = this.int();
result.random_id = this.bytes();
result.peer = this.predicate();
if (result.flags & 1) result.sponsor_info = this.string();
if (result.flags & 2) result.additional_info = this.string();
return result;
  }],
  [3929191601, function() {
const result: any = { _: 'contacts.sponsoredPeersEmpty' };
return result;
  }],
  [3942852740, function() {
const result: any = { _: 'contacts.sponsoredPeers' };
result.peers = this.vector(this.predicate, false);
result.chats = this.vector(this.predicate, false);
result.users = this.vector(this.predicate, false);
return result;
  ...
  [4103700034, function() {
const result: any = { _: 'inputInvoiceBusinessBotTransferStars' };
result.bot = this.predicate();
result.stars = this.long();
return result;
  }],
  [4261839423, function() {
const result: any = { _: 'inputGroupCallSlug' };
result.slug = this.string();
return result;
  }],
  [2349883455, function() {
const result: any = { _: 'inputGroupCallInviteMessage' };
result.msg_id = this.int();
return result;
  }],
  [2759272591, function() {
const result: any = { _: 'updateGroupCallChainBlocks' };
result.call = this.predicate();
result.sub_chain_id = this.int();
result.blocks = this.vector(this.bytes, false);
result.next_offset = this.int();
return result;
  }],
  [805187450, function() {
const result: any = { _: 'messageActionConferenceCall' };
result.flags = this.int();
result.missed = !!(result.flags & 1);
result.active = !!(result.flags & 2);
result.video = !!(result.flags & 16);
result.call_id = this.long();
if (result.flags & 4) result.duration = this.int();
if (result.flags & 8) result.other_participants = this.vector(this.predicate);
return result;
  }],
  [2679894519, function() {
const result: any = { _: 'phoneCallDiscardReasonMigrateConferenceCall' };
result.slug = this.string();
return result;
  }],
  [545636920, function() {
const result: any = { _: 'inputSavedStarGiftSlug' };
result.slug = this.string();
return result;
  }],
  [1219145276, function() {
const result: any = { _: 'starGiftAttributeIdModel' };
result.document_id = this.long();
return result;
  }],
  [1242965043, function() {
const result: any = { _: 'starGiftAttributeIdPattern' };
result.document_id = this.long();
return result;
  }],
  [520210263, function() {
const result: any = { _: 'starGiftAttributeIdBackdrop' };
result.backdrop_id = this.int();
return result;
  }],
  [783398488, function() {
const result: any = { _: 'starGiftAttributeCounter' };
result.attribute = this.predicate();
result.count = this.int();
return result;
  }],
  [2491028191, function() {
const result: any = { _: 'payments.resaleStarGifts' };
result.flags = this.int();
result.count = this.int();
result.gifts = this.vector(this.predicate, false);
if (result.flags & 1) result.next_offset = this.string();
if (result.flags & 2) result.attributes = this.vector(this.predicate);
if (result.flags & 2) result.attributes_hash = this.long();
result.chats = this.vector(this.predicate, false);
if (result.flags & 4) result.counters = this.vector(this.predicate);
result.users = this.vector(this.predicate, false);
return result;
  }],
  [3281998628, function() {
const result: any = { _: 'inputInvoiceStarGiftResale' };
result.flags = this.int();
result.ton = !!(result.flags & 1);
result.slug = this.string();
result.to_id = this.predicate();
return result;
  }],
  [3306682238, function() {
const result: any = { _: 'channelAdminLogEventActionToggleAutotranslation' };
result.new_value = this.predicate();
return result;
  }],
  [3280453710, function() {
const result: any = { _: 'stories.canSendStoryCount' };
result.count_remains = this.int();
return result;
  }],
  [3890753042, function() {
const result: any = { _: 'pendingSuggestion' };
result.suggestion = this.string();
result.title = this.predicate();
result.description = this.predicate();
result.url = this.string();
return result;
  }],
  [1775660101, function() {
const result: any = { _: 'inputReplyToMonoForum' };
result.monoforum_peer_id = this.predicate();
return result;
  }],
  [1681948327, function() {
const result: any = { _: 'monoForumDialog' };
result.flags = this.int();
result.unread_mark = !!(result.flags & 8);
result.nopaid_messages_exception = !!(result.flags & 16);
result.peer = this.predicate();
result.top_message = this.int();
result.read_inbox_max_id = this.int();
result.read_outbox_max_id = this.int();
...
return result;
  ...
  [2008081266, function() {
const result: any = { _: 'updateReadMonoForumInbox' };
result.channel_id = this.long();
result.saved_peer_id = this.predicate();
result.read_max_id = this.int();
return result;
  }],
  [2762445686, function() {
const result: any = { _: 'updateReadMonoForumOutbox' };
result.channel_id = this.long();
result.saved_peer_id = this.predicate();
result.read_max_id = this.int();
return result;
  ...
  [3416892719, function() {
const result: any = { _: 'todoItem' };
result.id = this.int();
result.title = this.predicate();
return result;
  }],
  [1236871718, function() {
const result: any = { _: 'todoList' };
result.flags = this.int();
result.others_can_append = !!(result.flags & 1);
result.others_can_complete = !!(result.flags & 2);
result.title = this.predicate();
result.list = this.vector(this.predicate, false);
return result;
  }],
  [1287725239, function() {
const result: any = { _: 'todoCompletion' };
result.id = this.int();
result.completed_by = this.long();
result.date = this.int();
return result;
  }],
  [2680512478, function() {
const result: any = { _: 'inputMediaTodo' };
result.todo = this.predicate();
return result;
  }],
  [2320740372, function() {
const result: any = { _: 'messageMediaToDo' };
result.flags = this.int();
result.todo = this.predicate();
if (result.flags & 1) result.completions = this.vector(this.predicate);
return result;
  }],
  [3430702217, function() {
const result: any = { _: 'messageActionTodoCompletions' };
result.completed = this.vector(this.int, false);
result.incompleted = this.vector(this.int, false);
return result;
  }],
  [3354246275, function() {
const result: any = { _: 'messageActionTodoAppendTasks' };
result.list = this.vector(this.predicate, false);
return result;
  }],
  [2676042504, function() {
const result: any = { _: 'updateMonoForumNoPaidException' };
result.flags = this.int();
result.exception = !!(result.flags & 1);
result.channel_id = this.long();
result.saved_peer_id = this.predicate();
return result;
  }],
  [244201445, function() {
const result: any = { _: 'suggestedPost' };
result.flags = this.int();
result.accepted = !!(result.flags & 2);
result.rejected = !!(result.flags & 4);
if (result.flags & 8) result.price = this.predicate();
if (result.flags & 1) result.schedule_date = this.int();
return result;
  }],
  [4000978326, function() {
const result: any = { _: 'messageActionSuggestedPostApproval' };
result.flags = this.int();
result.rejected = !!(result.flags & 1);
result.balance_too_low = !!(result.flags & 2);
if (result.flags & 4) result.reject_comment = this.string();
if (result.flags & 8) result.schedule_date = this.int();
if (result.flags & 16) result.price = this.predicate();
return result;
  }],
  [2514341737, function() {
const result: any = { _: 'messageActionSuggestedPostSuccess' };
result.price = this.predicate();
return result;
  }],
  [1777932024, function() {
const result: any = { _: 'messageActionSuggestedPostRefund' };
result.flags = this.int();
result.payer_initiated = !!(result.flags & 1);
return result;
  }],
  [1957618656, function() {
const result: any = { _: 'starsTonAmount' };
result.amount = this.long();
return result;
  }],
  [2829305497, function() {
const result: any = { _: 'messageActionGiftTon' };
result.flags = this.int();
result.currency = this.string();
result.amount = this.long();
result.crypto_currency = this.string();
result.crypto_amount = this.long();
if (result.flags & 1) result.transaction_id = this.string();
return result;
  }],
  [485912992, function() {
const result: any = { _: 'inputStickerSetTonGifts' };
return result;
  }],
  [453922567, function() {
const result: any = { _: 'starsRating' };
result.flags = this.int();
result.level = this.int();
result.current_level_stars = this.long();
result.stars = this.long();
if (result.flags & 1) result.next_level_stars = this.long();
return result;
  }],
  [2641040304, function() {
const result: any = { _: 'starGiftCollection' };
result.flags = this.int();
result.collection_id = this.int();
result.title = this.string();
if (result.flags & 1) result.icon = this.predicate();
result.gifts_count = this.int();
result.hash = this.long();
return result;
  }],
  [2696564503, function() {
const result: any = { _: 'payments.starGiftCollectionsNotModified' };
return result;
  }],
  [2317955827, function() {
const result: any = { _: 'payments.starGiftCollections' };
result.collections = this.vector(this.predicate, false);
return result;
  }],
  [2468704346, function() {
const result: any = { _: 'storyAlbum' };
result.flags = this.int();
result.album_id = this.int();
result.title = this.string();
if (result.flags & 1) result.icon_photo = this.predicate();
if (result.flags & 2) result.icon_video = this.predicate();
return result;
  }],
  [1448008427, function() {
const result: any = { _: 'stories.albumsNotModified' };
return result;
  }],
  [3281549882, function() {
const result: any = { _: 'stories.albums' };
result.hash = this.long();
result.albums = this.vector(this.predicate, false);
return result;
  }],
  [1040931690, function() {
const result: any = { _: 'searchPostsFlood' };
result.flags = this.int();
result.query_is_free = !!(result.flags & 1);
result.total_daily = this.int();
result.remains = this.int();
if (result.flags & 2) result.wait_till = this.int();
result.stars_amount = this.long();
return result;
  }],
  [835375875, function() {
const result: any = { _: 'webPageAttributeStarGiftCollection' };
result.icons = this.vector(this.predicate, false);
return result;
  }],
  [2584430776, function() {
const result: any = { _: 'inputInvoiceStarGiftPrepaidUpgrade' };
result.peer = this.predicate();
result.hash = this.string();
return result;
  }],
  [1362093126, function() {
const result: any = { _: 'payments.uniqueStarGiftValueInfo' };
result.flags = this.int();
result.last_sale_on_fragment = !!(result.flags & 2);
result.value_is_average = !!(result.flags & 64);
result.currency = this.string();
result.value = this.long();
result.initial_sale_date = this.int();
result.initial_sale_stars = this.long();
result.initial_sale_price = this.long();
if (result.flags & 1) result.last_sale_date = this.int();
if (result.flags & 1) result.last_sale_price = this.long();
if (result.flags & 4) result.floor_price = this.long();
if (result.flags & 8) result.average_price = this.long();
if (result.flags & 16) result.listed_count = this.int();
if (result.flags & 32) result.fragment_listed_count = this.int();
if (result.flags & 32) result.fragment_listed_url = this.string();
return result;
  }],
  [3113014934, function() {
const result: any = { _: 'profileTabPosts' };
return result;
  }],
  [1296815210, function() {
const result: any = { _: 'profileTabGifts' };
return result;
  }],
  [1925597525, function() {
const result: any = { _: 'profileTabMedia' };
return result;
  }],
  [2872286208, function() {
const result: any = { _: 'profileTabFiles' };
return result;
  }],
  [2670187118, function() {
const result: any = { _: 'profileTabMusic' };
return result;
  }],
  [3833006382, function() {
const result: any = { _: 'profileTabVoice' };
return result;
  }],
  [3546637465, function() {
const result: any = { _: 'profileTabLinks' };
return result;
  }],
  [2730555029, function() {
const result: any = { _: 'profileTabGifs' };
return result;
  }],
  [3817310884, function() {
const result: any = { _: 'users.savedMusicNotModified' };
result.count = this.int();
return result;
  }],
  [883094167, function() {
const result: any = { _: 'users.savedMusic' };
result.count = this.int();
result.documents = this.vector(this.predicate, false);
return result;
  }],
...
return result;
  ...
  [2576180790, function() {
const result: any = { _: 'account.savedMusicIds' };
result.ids = this.vector(this.long, false);
return result;
  }],
  [927967149, function() {
const result: any = { _: 'payments.checkCanSendGiftResultOk' };
return result;
  }],
  [3588588148, function() {
const result: any = { _: 'payments.checkCanSendGiftResultFail' };
result.reason = this.predicate();
return result;
  }],
  [878246344, function() {
const result: any = { _: 'chatThemeUniqueGift' };
result.gift = this.predicate();
result.theme_settings = this.vector(this.predicate, false);
return result;
  }],
  [2200339587, function() {
const result: any = { _: 'inputChatThemeEmpty' };
return result;
  }],
  [3376277852, function() {
const result: any = { _: 'inputChatTheme' };
result.emoticon = this.string();
return result;
  }],
  [2279989220, function() {
const result: any = { _: 'inputChatThemeUniqueGift' };
result.slug = this.string();
return result;
  }],
]);
